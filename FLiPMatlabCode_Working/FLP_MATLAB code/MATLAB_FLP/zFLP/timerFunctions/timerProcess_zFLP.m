...
state.pcell.pcellScanning1=10; %Yao added on 8/8/2020 override the pcellScanning required for imaging.
...
try
    ...
    spc.datainfo.zFLIP_triggerTime = datestr(startTime, 'dd-mmm-yyyy HH:MM:SS.FFF'); %Xubo 11/07/20: record both zFLP and phys triggerTime; increase recorded resolution
    spc.datainfo.phys_triggerTime = datestr(state.internal.triggerTime, 'dd-mmm-yyyy HH:MM:SS.FFF');
end
